    ...
    return (
        <>
            ...
            <div className="mx-auto w-full max-w-3xl p-4 sm:p-6 lg:p-8">
                ...
                <div className="mb-8">
                    <p className="text-muted-foreground text-sm font-medium">New community goal</p>
                    <h1 className="mt-1 text-3xl font-semibold tracking-tight">What are you trying to accomplish?</h1>
                    <p className="text-muted-foreground mt-3 max-w-2xl leading-7">
                        Describe the outcome clearly. Methods and real experiences will be attached to this goal in the next step of Workbine.
                    </p>
                </div>

                <Form action="/goals" method="post" disableWhileProcessing className="space-y-6">
                    {({ processing, errors }) => (
                        <>
                            <div className="grid gap-2">
                                ...
                                <p className="text-muted-foreground text-sm">
                                    Start with the result someone wants, not with a specific solution.
                                </p>
