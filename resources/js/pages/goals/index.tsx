                    ...
                    <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
                        <div className="max-w-3xl">
                            ...
                            <p className="text-muted-foreground mt-6 max-w-2xl text-lg leading-8">
                                Workbine collects practical methods, evidence
                                and real-world experience so useful answers are
                                easier to trust.
                            </p>
                ...
                >
                    ...
                    {goals.data.length > 0 ? (
                                    ...
                                    <Card className="h-full transition-shadow group-hover:shadow-md">
                                        ...
                                        <CardContent>
                                            <p className="text-muted-foreground line-clamp-3 text-sm leading-6">
                                                {goal.description ??
                                                    'No description yet. Open the goal to see community methods as they are added.'}
                                            </p>
                                        </CardContent>
                                    </Card>
                                </Link>
                        ...
                        <div className="border-border bg-muted/20 rounded-xl border border-dashed px-6 py-16 text-center">
                            ...
                            <p className="text-muted-foreground mx-auto mt-2 max-w-md text-sm leading-6">
                                Be the first person to describe something worth
                    ...
                    {goals.last_page > 1 && (
                        <div className="mt-10 flex items-center justify-between">
                            <Button
                                asChild={Boolean(goals.prev_page_url)}
                                variant="outline"
                                disabled={!goals.prev_page_url}
                            >
                                {goals.prev_page_url ? (
                                    <Link href={goals.prev_page_url}>
                                        Previous
                                    </Link>
                                ) : (
                                    <span>Previous</span>
                            ...
                            <Button
                                asChild={Boolean(goals.next_page_url)}
                                variant="outline"
                                disabled={!goals.next_page_url}
                            >
                                {goals.next_page_url ? (
                                    <Link href={goals.next_page_url}>Next</Link>
                                ) : (
                                    <span>Next</span>
                                )}
                            </Button>
