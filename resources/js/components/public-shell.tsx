...
export function PublicShell({ children }: Props) {
    ...
    return (
        <div className="wb-public flex min-h-screen flex-col">
            <a
                href="#main-content"
                className="bg-background sr-only z-50 px-4 py-3 focus:not-sr-only focus:fixed focus:top-3 focus:left-3"
            >
                Skip to content
            </a>
            <header className="wb-topbar">
                <div className="wb-topbar-inner">
                    ...
                    <nav aria-label="Main navigation" className="wb-main-nav">
                        <Link href="/topics" className="wb-toplink">
                            Community
                        </Link>
                        <Link href="/#field-guide" className="wb-toplink">
                            Field guide
                        </Link>
                        {auth.user ? (
                            <>
            ...
            <footer className="wb-footer">
                <div className="wb-footer-inner">
                    <p>
                        <strong>workbine.</strong>A shared notebook, not a feed
                        of promises.
                    </p>
                    <Link href="/topics/create">
