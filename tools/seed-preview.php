...
User::factory()->create(['name' => 'Preview Moderator', 'email' => 'preview-moderator@example.test', 'password' => Hash::make('preview-only-password')]);
User::factory()->create(['name' => 'Preview Moderation Author', 'email' => 'preview-moderation-author@example.test', 'password' => Hash::make('preview-only-password')]);
